...
Additional evidence of meaning change along future/modal pathways is to be found in Indo-European. According to \citet[106]{Fortson2010}: the \acrshort{PIE} ``subjunctive was probably a future tense'', he notes •~that this form is continued as the subjunctive of Indo-Iranian, Greek and Celtic and, • descends as the future in Latin (as it also likely did probably in Vedic (214)).
...
\pex\deftagex{futII} \textbf{Future-reference encoded with \gls{II}}
...
\begin{figure}[h]\caption[\textsc{temporal schema}. \textsc{wd} inflection]{Past-time temporal expression in the Yolŋu Matha varieties of Central Arnhem, demonstrating two descriptive phenomena: (a) cyclicity --- the interspersion/discontinuity of \gls{I} and \gls{III} forms and (b) metricality --- the (subjective) division of the past domain between these two forms.\\$\lfloor{\sl today}\rfloor$ indicates the boundaries of the day of utterance. $\boldsymbol{t*}$ is utterance time.}\label{TempSchem}\centering
	\begin{tikzpicture}[scale=1.1]
		...
		% draw nodes
		\draw (1.25,0) node[below=3pt] {\textbf{}} node[above=15pt] {\textsc{\gls{III}}};
		\draw (3.675,0) node[below=3pt] {\textbf{}} node[above=15pt] {\gls{I}};
		...
		\draw (5.8,0) node[below=3pt] {\textbf{}} node[above=15pt] {\textsc{\gls{III}}};	
		\draw (8.15,0) node[below=3pt] {\textbf{}} node[above=15pt] {\textsc{\gls{I}}};	
...
\ex\begingl\glpreamble\textsb{\textit{djaṉ\kern-.0525 em ŋ\kern -.06em arrthin} `hungry': post-state \& present-predication}\deftagex{hungry}//
...
\subsection{Aspect \& temporal interpretation}
