...
\setsansfont[Numbers={OldStyle},BoldItalicFont=Linux Biolinum T]{Linux Biolinum O}
\usepackage{soul}
...
\vspace*{.75in}	\textbf{ At the Intersection of Temporal \& Modal Interpretation:}\\
		{Essays on Irreality}%\\\textit{[working title]}
...
%	\HRule
	...
	{ by
		...
		{\textbf{Joshua Phillips}}%\\\scriptsize BInSt (Hons I\textsuperscript★)  (UNSW)\\[-.625em]MA, MPhil (Yale)
	}
	\vspace{.6in}
